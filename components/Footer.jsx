                ...
                <div className="col-md-8 col-12 d-flex justify-content-md-end  justify-content-center">
                    ...
                    <div className="row">
                        <div className="d-flex justify-content-md-end  justify-content-center mb-3">
                            <a href='https://twitter.com/stipill1' target='_blank'  className="text-decoration-none text-light"><i className="bi bi-twitter"></i> </a> <br />
                            <a href='https://facebook.com/stipill' target='_blank'  className="ms-4 text-decoration-none text-light"><i className="bi bi-facebook"></i> </a> <br />
                            <a href='https://github.com/stipill' target='_blank'  className="ms-4 text-decoration-none text-light"><i className="bi bi-github"></i> </a> <br />
                            <a href='https://www.linkedin.com/company/stipill/' target='_blank'  className="ms-4 text-decoration-none text-light"><i className="bi bi-linkedin"></i> </a> <br />
                        </div>
